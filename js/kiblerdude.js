...
kiblerdude.controller('SongController', function($scope) {
  $scope.music = [{
    ...
    "Songs":[
      ...
      { "Artist":"Goo Goo Dolls", "Song":"Black Balloon", "new":true },
      ...
      { "Artist":"Oasis", "Song":"Champagne Supernova", "new":true },
    ...
    "Songs":[
      ...
      { "Artist":"Tom Petty", "Song":"American Girl", "new":true },
    ...
    "Songs":[
      ...
      { "Artist":"Garth Brooks", "Song":"Wrapped Up In You", "new": true },
